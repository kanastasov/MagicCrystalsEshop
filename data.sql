...
VALUES (
                ...
                'Кристали',
                LOAD_FILE(
                        'C:\Program Files\MySQL\MySQL Server 8.0\Uploads\cr1.jpg'
                ),
                'image/jpeg',
                'Кристали.',
                'Използват се за успокоение',
                99.99
        ),
        (
                2,
                'Кристали',
                LOAD_FILE(
                        'C:\Program Files\MySQL\MySQL Server 8.0\Uploads\cr3.jpg'
                ),
                'image/jpeg',
                'Минерали',
                'Добър за подарък',
...
SELECT LOAD_FILE(
                'C:\Users\kirep\OneDrive\Desktop\DeniMagicCrystals\E-CommerceWebsite\img\cr1.jpg'
        );
SELECT LOAD_FILE(
                'C:\Program Files\MySQL\MySQL Server 8.0\Uploads\cr1.jpg'
        );
...
from orders
select *
from order_items CREATE TABLE orders (
                id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `crystals` (
        ...
        -- Stores GitHub image link instead of binary data
...
VALUES (
                'Необработени Скъпоценни и Полускъпоценни Камъни',
                'Необработен',
...
VALUES (1, 'admin', 'MagicCrystals57?')
UPDATE magiccrystals.preview
set name = 'Шипове и Обелиски',
        type = 'Шипове и Обелиски'
where id = 5;
select *
from magiccrystals.products
where id = 1
select *
from magiccrystals.preview
where id = 5
UPDATE magiccrystals.products
SET price = 38
WHERE id = 123;
delete from magiccrystals.preview
where id = 9;
SELECT *
FROM products
where id = 39;
...
VALUES ('admin', 'admin');
select *
from preview use magiccrystals;
select *
from products
where type = 'Сувенири от Полускъпоценни Камъни'
SELECT *
FROM admins
...
VALUES (
        ...
        (
                'Рози',
                'Розов опал,Тигорво око ,Яспис,цитрин,Розов кварц ,Оникс',
                49,
                'Полирани Камъни',
        ...
        (
                'Метличка',
                'Метличка 39 лв с камък опалит и аметист. Метлата е символ на домашния уют и семейното щастие и играе основна роля при защитата му.',
                39,
                'Полирани Камъни',
        ...
        (
                'Метличка',
                'Метличка с камък опалит и аметист
Метлата е символ на домашния уют и семейното щастие и играе основна роля при защитата му.',
                45,
                'Полирани Камъни',
...
Метлата е символ на домашния уют и семейното щастие и играе основна роля при защитата му.',
        ...
        (
                'Олгонит Метатрон',
                'Балансира ума и намалява нивата на емоционален стрес. Създаден е да събира в себе си негатива от околното пространство и да го трансформира в чиста и позитивна енергия за своя притежател, в името на неговото най-висше благо и добро – За да има пълната сила на Светлината в Живота си!',
                62,
                'Полирани Камъни',
        ...
        (
                'Пирамиди оргонит',
                'Аметист, Цитрин, яспис,тигрово око,авантюрин,цитрин,лазурит и др',
                20,
                'Полирани Камъни',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/3%20Полирани%20Камъни/10.jpg'
        ),
        (
                'Китайски монети 25лв благополучие и просперитет',
                'Тези амулети са създадени според принципите на Фън Шуй и се използват, за да внесат късмет, просперитет и баланс в живота на тези, които ги използват.',
                25,
                'Полирани Камъни',
...
VALUES (
                'Скандинавски руни за гадаене от дърво',
                'Този комплект руни за гадаене съдържа 25 броя дървени шайби с руни в памучна торбичка.
...
Руните се появяват като символи  доста преди вековете на викингите, макар днес да са синоним на т. нар. Епоха на викингите88 лв',
                88,
                'Езотерични продукти',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/4%20Екзотерични/1.jpg'
        ),
        (
                'Дървени дъски за гадаене  с махало',
                'Този комплект руни за гадаене съдържа 25 броя дървени шайби с руни в памучна торбичка.
Дървени руни ръчна изработка с добавено тълкувание за всяка руна на български език.
Руните са сред най-старите азбуки, използвани предимно  от скандинавските народи, често като гадаене и предсказание за вземане на житейски решения и насоки.
Руните се появяват като символи  доста преди вековете на викингите, макар днес да са синоним на т. нар. Епоха на викингите',
                38,
                'Езотерични продукти',
...
Дървени руни ръчна изработка с добавено тълкувание за всяка руна на български език.
Руните са сред най-старите азбуки, използвани предимно  от скандинавските народи, често като гадаене и предсказание за вземане на житейски решения и насоки.
Руните се появяват като символи  доста преди вековете на викингите, макар днес да са синоним на т. нар. Епоха на викингите 52 -72лв',
                52,
                'Езотерични продукти',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/4%20Екзотерични/4.jpg'
        ),
        (
                'Комплект колие и гривна розов опал със сребърна закопчалка',
                'Комплект колие и гривна розов опал 89лв със сребърна закопчалка',
                89,
                'Езотерични продукти',
...
(
        'Благороден бял опал със сребърна закопчалка',
        'Благороден бял опал със сребърна закопчалка  Произход Етиопия със сребърна закопчалка',
        148,
        'бижута',
        'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/6.jpg'
),
(
        'Черен благороден опал със сребърна',
        'Черен благороден опал със сребърна',
        154,
        'бижута',
...
(
        'Комплект гривна и гердан Лазурит',
        'Комплект гривна и гердан Лазурит 120лв като талисман прогонва нещастията,носи надежда,здраве и благоденствие. Зодии: Дева ,стрелец козирог със сребърна закопчалка',
        120,
        'бижута',
...
(
        'Тигрово око',
        'Тигрово око 120лв. Зодии: Дева ,стрелец козирог',
        120,
        'бижута',
...
(
        'Чароит',
        'Камъкът на духа и духовната проницателност.Той преобразува негативната енергия в лечебна,дава стремеж,жизненост и е способен да намали стреса и безпокойствието. Това е камъкът на трансформацията със сребърна закопчалка',
        120,
        'бижута',
...
(
        'Тюркоаз камъкът на благоденствието',
        'Тюркоаз камъкът на благоденствието,силно  пречистващ и предпазващ от зли очи и негативна енергия.Носи спокойствие на духа и добро физическо състояние. Зодии ,риби скорпион, стрелец,водолей овен, със сребърна закопчалка',
        120,
        'бижута',
...
(
        'Цитрин',
        'Цитрин. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        80,
        'бижута',
...
(
        'Содалит',
        'Содалит. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        80,
        'бижута',
...
(
        'Унакит',
        'Благороден Унакит. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        85,
        'бижута',
...
(
        'Аместит',
        'Аместит. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        85,
        'бижута',
...
(
        'Тюркоаз',
        'Благороден Тюркоаз. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        85,
        'бижута',
...
(
        'Черен оникс',
        'Черен оникс. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        85,
        'бижута',
...
(
        'Рубин в циозит',
        'Благороден Рубин в циозит. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        85,
        'бижута',
...
(
        'Опушен кварц',
        'Благороден Опушен кварц. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        85,
        'бижута',
...
(
        'Ахат',
        'Ахат. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        85,
        'бижута',
...
(
        'Аквамарин',
        'Дарява спокойствие на тези който го носят ,помага за намаляване на стреса и постигане на вътрешен мир.Изостря интуицията и проницателността. Скорпион ,Овен теелец близнаци везни водолей риби, със сребърна закопчалка',
        85,
        'бижута',
...
(
        'Авантюрин',
        'Авантюрин. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        80,
        'бижута',
...
(
        'Планински кристал гердан',
        'Планински кристал гердан. Зодии: Дева ,стрелец козирог, със сребърна закопчалка',
        45,
        'бижута',
...
(
        'Келтски възел',
        'Келтски възел 85лв Амулет за защита японски самурай 85лв',
        85,
        'бижута',
        'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/32.jpg'
),
(
        'Амулет Сан Бенито',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        94,
        'бижута',
...
(
        'Мъжки гердан/колие Черен оникс,Тигорово око и хематит',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        143,
        'бижута',
...
(
        'Лава ,тигорово око с глави на Буда',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        126,
        'бижута',
...
(
        'Черна лава, мед и снежен обсидиан',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        87,
        'бижута',
...
(
        'Елегантни висулки светещи камък нефрит  вграден в метал със златист оттенък, който е изрязан с малки китайски дракони.',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        45,
        'бижута',
...
(
        'Движеща се месингова драконова фигурка със златисто покритие',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        43,
        'бижута',
...
(
        'Луксозна стъклена парфюмна бутилка',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        52,
        'бижута',
...
(
        'Амулет защита с различни видове камък: аметист, цитрин,цветен флоурит и лапис лазули',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        63,
        'бижута',
...
(
        'Кристални ябълки. Аметист, Опал, розов кварц ,авантюрин и планински кристал',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        35,
        'бижута',
...
(
        'Фигури на Ангел пазител тиговро око,мялахит,далматински яспис ,опал, планински кристал и др.',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        30,
        'бижута',
...
(
        'Фигури жаби  малахит,авантюрин, тигорово око,тюркоаз, розов кварц,опал,планински кристал и други',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        28,
        'бижута',
...
(
        'Костенурки аметист,червен яспис,лазурит и др',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        28,
        'бижута',
...
(
        'Бухалче авантюрин, лапис лазули, аметист и др',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        43,
        'бижута',
...
(
        'Стъклени бутилки дозатор за парфюм,етерични масла с камъни аметист,тюроказ,тигрово око,авантюрин, карнеол,содалит и др',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        20,
        'бижута',
...
(
        '7те чакри дървото на живота с медна тел с кристали аметист, цитрин, Тюркоаз, авантюрин, содалит, карнеол и яспис',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        25,
        'бижута',
...
(
        'дърво на късмета с пари с жълт и розов кварц',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        58,
        'бижута',
...
(
        'Обици различни видове с тигрово око,авантюрин, малахит, тюркоаз, розов кварц, опалит и др',
        'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
        58,
        'бижута',
...
VALUES (
        ...
        (
                'Гривни',
                'Гривни 30лв,40,45-48лв зависи какъв камък тигрово око,лабрадорит, содалит,тюркоаз,аметист,цитрин,планински кристал,ахат,розов кварц ,мокаид,родонит,малинов кварц,лазурит,опал,карнеол,авантюрин и др.',
                30,
                'бижута',
        ...
        (
                'Пирамиди тигрово',
                'Пирамиди тигрово 42лв  око,аметист 36лв и лапис лазули 42лв',
                42,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/56.jpg'
        ),
        (
                'Комплект гривна,гердан и обеци 48лв Аметист',
                'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
                48,
                'бижута',
        ...
        (
                'Гривна кианит',
                'Гривна кианит 100лв камъкът ,който не натрупва отрицателни енергии,носи спокойствие и релаксация. Дарява с вдъхновение и успех.',
                100,
                'бижута',
        ...
        (
                'Чароит гривна',
                'Чароит гривна 100лв камъкът на духа и духовната проницателност.Той преобразува негативната енергия в лечебна,дава стремеж, жизненост и е способен да намали стреса и безпокойството.Това е камъкът на трансформацията',
                100,
                'бижута',
        ...
        (
                'Аквамарин камъкът',
                '100лв аквамарин камъкът  дарява спокойствие,помага за намаляване на стреса и постигане на вътрешен мир.',
                100,
                'бижута',
        ...
        (
                'Черен турмалин',
                '100лв Черен турмалин - той е един от най-мощните кристали за защита.Има способността да пречиства вашата енергия, да предпазва от отрицателни влияния.Подходящ за всички зодии.',
                100,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/73.jpg'
        ),
        (
                'Гривна с многоцветни мъниста',
                'Открийте изящни, ръчно изработени бижута, които съчетават елегантност, качество и неподражаем стил за всеки повод.',
                30,
                'бижута',
...
CREATE TABLE `reviews` (
        ...
        PRIMARY KEY (`id`),
        CONSTRAINT `reviews_chk_1` CHECK (
                (
...
VALUES (
        ...
        (
                'Таро оракулски карти за гадаене',
                'Таро оракулски карти за гадаене 45лв',
                45,
                'Езотерични продукти',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/4%20Екзотерични/6.jpg'
        ),
        (
                'Телепатично Оракулно Тесте',
                'Телепатично Оракулно Тесте с 56 Карти за Яснота и Гадаене и таро карти Градината на вещицата Тесте от 78 карти',
                48,
                'Езотерични продукти',
        ...
        (
                'Романтични ангелски оракулски карти',
                'Романтични ангелски оракулски карти 44 карти подходящи и за начинаещи',
                55,
                'Езотерични продукти',
...
VALUES (
                'Амулет за изобилие на дома',
                'Амулет за изобилие на дома 55лв',
                55,
                'Друзи',
        ...
        (
                'Кристални висулки',
                'Кристални висулки 28лв различни видове тюркоаз,малахит,авантюрин, опал,аквамарин и др.',
                28,
                'Друзи',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/2%20Друзи/41.jpg'
        ),
        (
                'Висулки различни видове',
                'Висулки различни видове 20лв',
                20,
                'Друзи',
...
VALUES (
                'Гривни черен обсидиан и лава',
                'Гривни черен обсидиан и лава с 7те камъка чакри 30лв',
                30,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/85.jpg'
        ),
        (
                'Ключодържател с котка на късмета и монети',
                '18лв Ключодържател с котка на късмета и монети на 5те императора',
                18,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/85.jpg'
        );
...
VALUES (
                'Елегантна мъжка гривна с тигрово око и хематит с магнитно закопчаване',
                'Елегантна мъжка гривна с тигрово око и хематит с магнитно закопчаване 85лв',
                85,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/87.jpg'
        ),
        (
                'Елегантна гривна 2 бр от камък снежен обсидиан',
                'Елегантна гривна 2 бр от камък снежен обсидиан и лава 85лв 1 бр.35лв',
                35,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/88.jpg'
        ),
        (
                'Гривни снежен обсидиан за добра съдба и богатство, черен абсидиан с лъвска глава',
                'Гривни снежен обсидиан за добра съдба и богатство, черен абсидиан с лъвска глава',
                85,
                'бижута',
        ...
        (
                'Стилни мъжки гривни тиговро око,лава,черен матов камък',
                'Стилни мъжки гривни тиговро око,лава,черен матов камък',
                58,
                'бижута',
        ...
        (
                'Мъжки гривни с магнитно закопчаване със снежен и  черен обсидиан, лава',
                'Мъжки гривни с магнитно закопчаване със снежен и  черен обсидиан, лава',
                65,
                'бижута',
        ...
        (
                'Унисекс гривна за Богатство с черен обсидиан и лава със сребърни и златисти акценти',
                'Унисекс гривна за Богатство с черен обсидиан и лава със сребърни и златисти акценти',
                62,
                'бижута',
        ...
        (
                'Елегантна мъжка гривна зелен малахит и хематит',
                'Елегантна мъжка гривна зелен малахит и хематит',
                76,
                'бижута',
        ...
        (
                'Унисекс гривна от малахит, лава и златни елементи',
                'Унисекс гривна от малахит, лава и златни елементи',
                73,
                'бижута',
        ...
        (
                'Мъжка гривна с лилав камък, лава и дървени акценти',
                'Мъжка гривна с лилав камък, лава и дървени акценти',
                52,
                'бижута',
...
VALUES (
                'Гривна Ангелит',
                'Гривна Ангелит 110лв -камъкът за вътрешен мир и спокойствие. Той повишава сетивното съзнание.Счита се ,че ангелитът има способността да заздравява връзката между човека и неговия ангел-пазител.',
                110,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/98.jpg'
        ),
        (
                'Гривна рубин в циозит',
                'Гривна рубин в циозит',
                66,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/99.jpg'
        ),
        (
                'Гривна цитрин',
                'Гривна цитрин',
                66,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/100.jpg'
        ),
        (
                'Гривна цитрин',
                'Гривна цитрин',
                55,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/101.jpg'
        ),
        (
                'Гривна цитрин',
                'Гривна цитрин',
                65,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/102.jpg'
        ),
        (
                'Гривна аметист, розов кварц и опалит',
                'Гривна аметист, розов кварц и опалит 66лв',
                66,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/103.jpg'
        ),
        (
                'Гривна цитрин',
                'Гривна цитрин',
                50,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/104.jpg'
        ),
        (
                'Гривна цитрин',
                'Гривна цитрин',
                66,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/105.jpg'
        ),
        (
                'Рубин в циозит',
                'Рубин в циозит',
                48,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/106.jpg'
        ),
        (
                'Черен благороден етиопски опал',
                'Черен благороден етиопски опал',
                90,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/107.jpg'
        ),
        (
                'Бял благороден опал',
                'Бял благороден опал',
                90,
                'бижута',
                'https://cdn.jsdelivr.net/gh/kanastasov/MagicCrystalsEshop@master/img/15бижута/108.jpg'
        );